...
$("#employeesTable").onclick=e=>{let a=e.target.closest("[data-edit-emp]"),d=e.target.closest("[data-del-emp]");if(a)openEmployee(a.dataset.editEmp);if(d&&confirm("حذف الموظف؟")){employees=employees.filter(x=>x.id!==d.dataset.delEmp);save();renderEmployees();prepForms();toast("تم حذف الموظف")}};
